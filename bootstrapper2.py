...
#                raise err
            ...
            OpUtil.log_operation_info("Finished.")
...
class OpUtil(object):
    ...
    def package_install(cls, user_volume_path) -> None:
        ...
        to_install_list = []
        OpUtil.log_operation_info("Looking for base requirements file.")
        ...
        subprocess.run(['cat', 'requirements-elyra.txt' ])
        OpUtil.log_operation_info("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
        subprocess.run(['cat', 'requirements-current.txt' ])
        OpUtil.log_operation_info("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
        subprocess.run(['pwd' ])
        OpUtil.log_operation_info("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
